...
public class LanceValueReaders {
  ...
  public static LanceValueReader<Boolean> booleans() {
    return BooleanReader.INSTANCE;
  }

  public static LanceValueReader<Integer> ints() {
    return IntegerReader.INSTANCE;
  }

  public static LanceValueReader<Long> longs() {
    return LongReader.INSTANCE;
  }

  public static LanceValueReader<Float> floats() {
    return FloatReader.INSTANCE;
  }

  public static LanceValueReader<Double> doubles() {
    return DoubleReader.INSTANCE;
  }

  public static LanceValueReader<byte[]> bytes() {
    return BytesReader.INSTANCE;
  }

  public static <C> LanceValueReader<C> constants(C constant) {
    return new ConstantReader<>(constant);
  }

  private static class BooleanReader implements LanceValueReader<Boolean> {
  ...
  private static class IntegerReader implements LanceValueReader<Integer> {
  ...
  private static class LongReader implements LanceValueReader<Long> {
  ...
  private static class FloatReader implements LanceValueReader<Float> {
  ...
  private static class DoubleReader implements LanceValueReader<Double> {
  ...
  private static class BytesReader implements LanceValueReader<byte[]> {
  ...
  public abstract static class StructReader<T> implements LanceValueReader<T> {
    private final LanceValueReader<?>[] readers;
    ...
    protected StructReader(
      ...
      this.readers = new LanceValueReader[fields.size()];
    ...
    public LanceValueReader<?> reader(int pos) {
      return readers[pos];
    }
    ...
    public void setBatchContext(long batchOffsetInFile) {
      for (LanceValueReader<?> reader : readers) {
        reader.setBatchContext(batchOffsetInFile);
      }
    }
  }

  private static class ConstantReader<C> implements LanceValueReader<C> {
  ...
  private static class RowPositionReader implements LanceValueReader<Long> {
